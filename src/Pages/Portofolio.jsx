...
const techStacks = [
  ...
  { icon: "bootstrap.svg", language: "Bootsrap" },
];
...
export default function FullWidthTabs() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const [projectsResponse, certificatesResponse] = await Promise.all([supabase.from("projects").select("*").order("id", { ascending: true }), supabase.from("certificates").select("*").order("id", { ascending: true })]);
  ...
  return (
    <div className="min-h-screen md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] overflow-hidden bg-gradient-to-br from-[rgb(249,224,239)] via-[rgb(244,244,255)] to-[rgb(214,247,247)]" id="Portofolio">
      {/* Header section - unchanged */}
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#a855f7] to-[#00B4D8]">
          <span
            style={{
              color: "#CAF0F8",
              backgroundImage: "linear-gradient(45deg, #a855f7 10%, #00B4D8 93%)",
        ...
        <p className="text-[#0096C7] max-w-2xl mx-auto text-sm md:text-base mt-2">Explore my journey through projects, certifications, and technical expertise. Each section represents a milestone in my continuous learning path.</p>
      </div>
